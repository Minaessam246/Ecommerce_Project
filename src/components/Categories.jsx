...
axios.get(`https://ecommerce.routemisr.com/api/v1/categories`).then((res)=>{setproducts(res.data.data);
setisLoading(false)
})
  }
...
{products.map((product)=>(
  <div key={product.id} className="w-96 home_product text-center products_item">
         
<img src={product.image} className='w-full h-64 object-cover' alt="" />
<h3 className='py-3 px-2 products_category font-stretch-50%'>{product.name}</h3>
